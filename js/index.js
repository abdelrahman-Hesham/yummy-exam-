...
function displayMeals(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartoona += `
        <div class="col-md-3 rounded-2 position-relative">
                <div onclick="getMealDetails('${arr[i].idMeal}')" class="data position-relative overflow-hidden rounded-2 cursor-pointer">
...
function displayCategories(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
        cartoona += `
        <div class="col-md-3">
                <div onclick="getCategoryMeals('${arr[i].strCategory}')" class="data position-relative overflow-hidden rounded-2 cursor-pointer">
